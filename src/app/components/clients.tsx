...
export default function Clients() {
  ...
  return (
    ...
    <section className="py-16 px-6 max-w-6xl mx-auto bg-black relative">
      {/* Header Section */}
      ...
      <div className="relative flex flex-col md:flex-row gap-8">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="w-full md:w-[48%] h-[400px] md:h-[360px] bg-black border border-[#C2C2C2] rounded-3xl shadow-md p-6 flex flex-col justify-between space-y-4"
          >
            {/* Client Info */}
